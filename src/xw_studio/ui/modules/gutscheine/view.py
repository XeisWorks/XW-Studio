...
class GutscheineView(QWidget):
    """Standalone Gutscheine queue (moved out of Rechnungen tabs)."""
    ...
    def reload(self) -> None:
        ...
        def job() -> list[dict[str, str]]:
            ...
            return service.load_queue_rows("gutscheine", fallback_count=0)
